...
function redactForNonAdmin(project: Record<string, unknown>): Project {
...
export function registerProjectTools(
  ...
  server.tool(
    ...
    "List projects from the Teamleader Focus (next-gen) projects module, with optional filtering and pagination.",
    {
      ...
      term: z
        ...
        .optional()
        .describe(
          "Search term - filters on project number, title, customer/assignee/owner names"
        ),
      status: z
        .enum([
          "open",
      ...
      deal_id: z.string().optional().describe("Filter by linked deal ID"),
      quotation_id: z
        .string()
        .optional()
    ...
    async (params) => {
      ...
      if (params.deal_id) filter.deal_ids = [params.deal_id];
      if (params.quotation_id) filter.quotation_ids = [params.quotation_id];
      ...
      if (!isAdmin) {
        result.data = result.data.map((p) =>
          redactForNonAdmin(p as unknown as Record<string, unknown>)
        );
      }
  ...
  server.tool(
    ...
    async (params) => {
      const result = await client.request<TeamleaderInfoResponse<Project>>({
        endpoint: "projects-v2/projects.info",
        body: { id: params.id },
      });

      if (!isAdmin) {
        result.data = redactForNonAdmin(
  ...
  server.tool(
    ...
    async (params) => {
      ...
      if (
        params.time_budget_value !== undefined &&
      ...
      if (
        params.external_budget_amount !== undefined &&
      ...
      if (
        params.internal_budget_amount !== undefined &&
      ...
      if (
        params.fixed_price_amount !== undefined &&
  ...
  server.tool(
    ...
    "Update an existing project. All fields except 'id' are optional. Use this to add or change the project's start_date/end_date, title, description, budgets, etc.",
    {
      ...
      billing_update_strategy: z
        .enum(["none", "cascade"])
        .optional()
        .describe(
          "Required when changing billing_method. 'none' = don't change group items; 'cascade' = also update groups/tasks/materials. Setting 'time_and_materials' requires 'none'; 'non_billable' requires 'cascade'."
        ),
      company_entity_id: z
        .string()
        .optional()
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID to close"),
      closing_strategy: z
        .enum(["mark_tasks_and_materials_as_done", "none"])
        .optional()
        .describe(
          "How to handle underlying tasks/materials when closing (default: none)"
        ),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID to reopen"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID to duplicate"),
      title: z.string().describe("Title for the new (duplicated) project"),
    },
    async (params) => {
      const result = await client.request<
        TeamleaderInfoResponse<{ id: string; type: string }>
  ...
  server.tool(
    ...
    "Assign a user or team to a project.",
    {
      ...
      assignee_id: z.string().describe("The user or team ID to assign"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    "Unassign a user or team from a project.",
    {
      ...
      assignee_type: z
        .enum(["user", "team"])
        .describe("Type of assignee"),
      assignee_id: z.string().describe("The user or team ID to unassign"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID"),
      user_id: z.string().describe("The user ID to add as owner"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID"),
      user_id: z.string().describe("The user ID to remove as owner"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID"),
      deal_id: z.string().describe("The deal ID to link"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID"),
      deal_id: z.string().describe("The deal ID to unlink"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID"),
      quotation_id: z.string().describe("The quotation ID to link"),
    },
    async (params) => {
      await client.request({
  ...
  server.tool(
    ...
    {
      id: z.string().describe("The project ID"),
      quotation_id: z.string().describe("The quotation ID to unlink"),
    },
    async (params) => {
      await client.request({
