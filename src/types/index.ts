...
export interface Project {
  ...
  owners?: IdObject[];
  color?: ProjectColor;
  assignees?: { assignee: IdObject; assign_type: string }[];
  customers?: IdObject[];
  deals?: IdObject[];
  quotations?: IdObject[];
}
...
export interface Quotation {
  ...
  expiry?: { expires_after?: string; action_after_expiry?: "lock" | "none" };
...
export type TimeTrackingSubjectType =
  | "company"
  | "contact"
  | "event"
  | "milestone"
